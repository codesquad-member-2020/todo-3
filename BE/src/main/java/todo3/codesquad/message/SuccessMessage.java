...
public class SuccessMessage {
    public static final String SUCCESS_LOGIN = "Login is Success";
    public static final String SUCCESS_SHOW = "Show data is Success";
    public static final String SUCCESS_CREATE = "Create data is Success";
